...
@export var rondas_para_ganar: int = 3 # ¡Tercer combate, un poco más difícil! (Mejor de 5)
@export var llave_que_da: String = "tarjeta_reactor" # La siguiente zona a desbloquear

# 3. Textos directos del alien con estilo de mecánico gruñón (el escarabajo)
@export var lineas_dialogo: Array[String] = [
	"¡Oye, chatarra andante! ¡Cuidado donde pisas! Acabo de engrasar esta rejilla de ventilación.",
	"Definitivamente tienes un tornillo suelto si crees que puedes deambular por mi zona de mantenimiento sin autorización.",
	"¡Saca tus herramientas! Vamos a ver si tus engranajes giran lo suficientemente rápido para vencerme en un duelo."
]
