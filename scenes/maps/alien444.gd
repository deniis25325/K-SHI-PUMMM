...
@export var rondas_para_ganar: int = 4 # Cuarto combate, ¡la dificultad sube!
@export var llave_que_da: String = "tarjeta_enfermeria" # O "tarjeta_seguridad", según tu mapa

# 3. Textos directos del alien con estilo de Jefe de Seguridad corporativo/burocrático
@export var lineas_dialogo: Array[String] = [
	"Ejem... Disculpa, ¿tienes el formulario 404 rellenado por triplicado para transitar por esta zona? No... lo suponía.",
	"Como Jefe de esta sección, mi deber contractual es aplastar... digo, amonestar severamente a los intrusos.",
	"Resolvamos esto de manera civilizada y corporativa. ¡Un duelo a muerte de táctica manual! Prepara tus nudillos."
]
