...
@export var rondas_para_ganar: int = 2 # Al ser el segundo combate, puedes subirlo a 2 si deseas
@export var llave_que_da: String = "tarjeta_mantenimiento"

# 3. Textos directos del alien con estilo científico y curioso
@export var lineas_dialogo: Array[String] = [
	"¡Bip, bop! Alerta de espécimen fuera de su contenedor... ¡Y ni siquiera traes puesta tu bata reglamentaria!",
	"Mis sensores bioquímicos detectan altos niveles de audacia en tus células. ¡Fascinante objeto de estudio!",
	"¡Prepara tus extremidades biológicas para resolver este conflicto mediante el juego de azar cuántico!"
]
